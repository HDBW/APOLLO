...
namespace De.HDBW.Apollo.Data.Tests.Repositories
{
    ...
    {
        public MetaDataMetaDataRelationRepositoryTests(ITestOutputHelper outputHelper)
            : base(outputHelper)
        {
        }
        ...
        {
            return new MetaDataMetaDataRelationRepository(this.SetupDataBaseConnectionProvider(context), this.SetupLogger<MetaDataMetaDataRelationRepository>(OutputHelper));
        }
    }
}
