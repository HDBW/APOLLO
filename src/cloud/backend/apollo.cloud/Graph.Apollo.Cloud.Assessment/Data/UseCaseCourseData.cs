    ...
    public class UseCaseCourseData
    {
        ...
        public Dictionary<long, CourseItem> CourseList = new Dictionary<long, CourseItem>()
        {
            ...
            { 0, new CourseItem() {
                                ...
                                Duration = TimeSpan.FromMinutes(129600).ToString(),//320 Unterrichtseinheiten je 45 min pro Modul + 120 Unterrichtseinheiten je 60 min im Unternehmen - 6 Module
            ...
            { 100, new CourseItem() {
                ...
                Occurrence = OccurrenceType.FullTime,
                Duration = TimeSpan.FromMinutes(129600).ToString(),
            ...
            { 101, new CourseItem() {
                ...
                CourseType = CourseType.Online,
                Occurrence = OccurrenceType.FullTime,
                Duration = TimeSpan.FromMinutes(14400).ToString(),
